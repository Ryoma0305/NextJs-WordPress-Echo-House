...
// import en from "../../../_locals/top/about/en";
// import ja from "../../../_locals/top/about/ja";
      ...
      <section className="relative bg-[url('/images/1floor-6.jpg')] bg-cover bg-center bg-no-repeat px-4 py-16 before:absolute before:inset-0 before:bg-about" id="about">
        <div className="relative">
          ...
          <p className="text-center leading-loose">
            ...
            <br /> 2018年にリニューアルオープンした女性専用シェアハウスです。
            <br /> 私達は、国籍やバックグラウンドが異なる住民の方々誰もが快適に過ごせるよう努め、
            <br /> エコーハウスを選んで良かったと言ってもらえるようなサービスを提供していきたいと思っています。
          </p>
        </div>
      </section>
    </FadeInBottom>
