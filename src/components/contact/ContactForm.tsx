  ...
  return (
    <form method="post" action="https://ssgform.com/s/aJa3hznVUi28" className="flex flex-col space-y-10">
      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">お問い合わせ種別</div>
      ...
      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">メールアドレス</div>
      ...
      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">電話番号</div>
      ...
      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">お名前</div>
        <input type="text" {...register("LastName")} className="mt-4 rounded-md border border-gray-100 px-3 py-2 text-gray-800" placeholder="例）山田" />
        {formatError.LastName && <div className="pl-1 pt-1 text-xs text-red-500">{formatError.LastName.message}</div>}
        <input type="text" {...register("GivenName")} className="mt-4 rounded-md border border-gray-100 px-3 py-2 text-gray-800" placeholder="例）太郎" />
        {formatError.GivenName && <div className="pl-1 pt-1 text-xs text-red-500">{formatError.GivenName.message}</div>}
      </label>

      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">年齢</div>
        <input type="text" {...register("Age")} className="mt-4 rounded-md border border-gray-100 px-3 py-2 text-gray-800" />
      </label>

      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">国籍</div>
        <input type="text" {...register("Country")} className="mt-4 rounded-md border border-gray-100 px-3 py-2 text-gray-800" />
      </label>

      <label className="flex flex-col space-y-1">
        <div className="mb-1 text-base font-bold">性別</div>
        <div className="flex gap-8">
          <div className="flex gap-2">
